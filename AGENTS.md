...
```text
Systronic/src/go2_control/TESTPLAN_TABLE.md              the field sheet: every case on one page
Systronic/src/go2_control/ONSITE_SCHEDULE_2026-09-14.md  what fits in the day, and what does not
Systronic/src/go2_control/MEASURE_TESTCASES.md           which number each case produces, and from where
